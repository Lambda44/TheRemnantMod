...
public class SoulGlowingEye extends AbstractGameEffect {
    private float x;
    private float y;
    private TextureAtlas.AtlasRegion img;

    public SoulGlowingEye(float x, float y) {
        ...
        this.scale = Settings.scale * MathUtils.random(0.3F, 0.7F);
        this.rotation = 0.0F;
        this.color = new Color(MathUtils.random(0.2F, 0.4F), MathUtils.random(0.8F, 1.0F), MathUtils.random(0.2F, 0.4F), 0.01F);
    }
