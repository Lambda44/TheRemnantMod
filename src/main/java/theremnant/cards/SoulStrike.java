...
public class SoulStrike extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "SoulStrike", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public SoulStrike() {
        ...
        this.cardsToPreview = new ForgottenSoul();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (this.upgraded) {
            AbstractCard s = (new ForgottenSoul()).makeCopy();
            s.upgrade();
            addToBot(new MakeTempCardInHandAction(s, 1));
        } else {
            addToBot(new MakeTempCardInHandAction(new ForgottenSoul(), 1));
        }
    }
