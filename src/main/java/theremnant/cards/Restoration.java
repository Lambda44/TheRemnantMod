...
public class Restoration extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Restoration", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (m.hasPower(ShatterPower.POWER_ID)) {
            int amt = m.getPower(ShatterPower.POWER_ID).amount * this.magicNumber;
