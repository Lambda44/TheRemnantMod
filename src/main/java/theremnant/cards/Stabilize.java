...
import theremnant.powers.StabilizePower;
import theremnant.powers.StockpilePower;
import theremnant.util.CardInfo;

import static theremnant.RemnantMod.makeID;

public class Stabilize extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Stabilize", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new StabilizePower(p, this.magicNumber), this.magicNumber));
    }
