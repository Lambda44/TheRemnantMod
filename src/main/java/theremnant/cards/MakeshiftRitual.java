...
public class MakeshiftRitual extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "MakeshiftRitual", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new TalkAction(true, "Caw... Caaaw?", 1.2F, 1.2F));
