...
public class MirrorShard extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "MirrorShard", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.hasPower(SoulPower.POWER_ID) && !this.upgraded) { //Soulcast if unupgraded
    ...
    public void triggerOnGlowCheck() {
        if (AbstractDungeon.player.hasPower(SoulPower.POWER_ID) && !this.upgraded) {
